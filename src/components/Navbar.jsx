    ...
    return (
        <div className='bg-slate-800 flex flex-row justify-between h-15 pl-1 pr-1 max-w-3xl'>
            ...
            <div className='h-12 space-x-4 flex items-center'>
                <button className='btn-small' onClick={toggleEditForm}>Edit</button>
                <button className='btn-large' onClick={deleteUser}>Delete</button>
                <button className='btn-small' onClick={toggleForm}>New</button>
            </div>
